...
local Build = load_("gen2/build.lua")
local Roll = load_("gen2/roll.lua")
local P = load_("gen2/placements.lua")
...
do
  ...
  local Trade = load_("gen2/trade.lua")
...
do
  ...
  local Statics = load_("gen2/statics.lua")
