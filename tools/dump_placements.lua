...
--
-- The Johto half of the document comes from tools/dump_placements2.lua, run at
-- the end of this file: one command, one generated file, two tables that each
-- read off the placement table their own half of the mod runs on.
--
...
dofile("tools/dump_placements2.lua")
